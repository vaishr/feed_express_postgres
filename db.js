...
client.query('CREATE TABLE IF NOT EXISTS posts(id SERIAL PRIMARY KEY, feed_message VARCHAR(40) not null, created_at VARCHAR(40), user_id integer REFERENCES users (id))');
